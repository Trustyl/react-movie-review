...
class MovieReview extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("https://api.nytimes.com/svc/movies/v2/reviews/all.json?query=&api-key=AQpfoTQb38rcRAXYzL3RioyAHN0PFWIl")
                ...
                <div className="review_box">
                    ...
                    <h1 className="h1_nav">
                        ...
                        <span>
                            ...
                            <Link to="/Stories" className="go_to_link"> Go To Top Stories API </Link>
                        </span>
                    </h1>
